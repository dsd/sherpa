...
int llamasherpa_process(const char *model_path, const char *_prompt, const char *_antiprompt, get_input_cb *get_input, show_output_cb *show_output) {
    std::string antiprompt(_antiprompt);
    ...
    llama_model * model  = llama_load_model_from_file(model_path, lparams);
    if (model == NULL) {
